...
resource "aws_elastic_beanstalk_environment" "default" {
  ...
  setting {
    ...
    value     = "${aws_rds_cluster.default.master_username}:${aws_rds_cluster.default.master_password}@tcp(${aws_rds_cluster_instance.master[0].endpoint}:3306)/${aws_rds_cluster.default.database_name}"
  }
